...
{
    public partial class frm_BaoCaoChieuCao : Form
    {
        string maTre = "";
        int nam;

        public frm_BaoCaoChieuCao(string maTre, int nam)
        {
            this.maTre = maTre;
            this.nam = nam;
            InitializeComponent();
        ...
        private void frm_BaoCaoChieuCao_Load(object sender, EventArgs e)
        {
